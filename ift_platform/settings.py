...
ALLOWED_HOSTS += ['.railway.app', '.indiafuturetycoons.com', '.enpower-school.com']
CSRF_TRUSTED_ORIGINS = [origin for origin in os.getenv('CSRF_TRUSTED_ORIGINS', '').split(',') if origin]
CSRF_TRUSTED_ORIGINS += [
    'https://*.railway.app', 'https://*.indiafuturetycoons.com', 'https://indiafuturetycoons.com',
    'https://*.enpower-school.com', 'https://enpower-school.com',
]
...
MIDDLEWARE = [
    'ift_platform.middleware.WWWCapgeminiRedirectMiddleware',
