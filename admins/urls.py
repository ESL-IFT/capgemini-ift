...
urlpatterns = [
    ...
    path('user-management/students/import/', views.import_students_csv, name='import_students_csv'),
    path('user-management/students/sample-csv/', views.download_students_sample_csv, name='download_students_sample_csv'),
    ...
    path('submissions/combined-sample-csv/', views.download_combined_submission_sample_csv, name='download_combined_submission_sample_csv'),
    path('submissions/combined-import/', views.import_combined_submissions_csv, name='import_combined_submissions_csv'),
